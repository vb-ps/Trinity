...
Partial Class Pre19ClientsForm
    ...
    Private Sub InitializeComponent()
        ...
        slinkydl.TabIndex = 6
        slinkydl.Text = "Download"
        slinkydl.UseVisualStyleBackColor = False
        ' 
        ' opaldl
        ' 
        ...
        opaldl.TabIndex = 7
        opaldl.Text = "Download"
        opaldl.UseVisualStyleBackColor = False
        ' 
        ' Label4
        ' 
        ...
        Label4.TabIndex = 8
        Label4.Text = "Slinky (Unchecked 1.8.9)"
        ' 
        ' Label5
        ' 
        ...
        Label5.TabIndex = 9
        Label5.Text = "Opal (Unchecked 1.21 - made for hypixel)"
        ' 
        ' Label6
        ' 
        ...
        Label6.TabIndex = 10
        Label6.Text = "Myau (Unchecked 1.8.9)"
        ' 
        ' myaudl
        ' 
